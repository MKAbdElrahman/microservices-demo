...
import (
	...
	context "context"
	v1 "demo/contracts/grpc/gen/health/v1"
	errors "errors"
	http "net/http"
	strings "strings"
)
...
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.HealthServiceCheckRequest]) (*connect.Response[v1.HealthServiceCheckResponse], error)
}
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	return &healthServiceClient{
		check: connect.NewClient[v1.HealthServiceCheckRequest, v1.HealthServiceCheckResponse](
			httpClient,
...
type healthServiceClient struct {
	check *connect.Client[v1.HealthServiceCheckRequest, v1.HealthServiceCheckResponse]
}

// Check calls health.v1.HealthService.Check.
func (c *healthServiceClient) Check(ctx context.Context, req *connect.Request[v1.HealthServiceCheckRequest]) (*connect.Response[v1.HealthServiceCheckResponse], error) {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.HealthServiceCheckRequest]) (*connect.Response[v1.HealthServiceCheckResponse], error) {
