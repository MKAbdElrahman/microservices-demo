...
const (
	AdService_GetAds_FullMethodName = "/ad.v1.AdService/GetAds"
)
...
type AdServiceClient interface {
	GetAds(ctx context.Context, in *GetAdRequest, opts ...grpc.CallOption) (*GetAdResponse, error)
}
...
func (c *adServiceClient) GetAds(ctx context.Context, in *GetAdRequest, opts ...grpc.CallOption) (*GetAdResponse, error) {
...
type AdServiceServer interface {
	GetAds(context.Context, *GetAdRequest) (*GetAdResponse, error)
...
func (UnimplementedAdServiceServer) GetAds(context.Context, *GetAdRequest) (*GetAdResponse, error) {
...
func _AdService_GetAds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdServiceServer).GetAds(ctx, req.(*GetAdRequest))
	}
...
var AdService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ad/v1/adservice.proto",
}
